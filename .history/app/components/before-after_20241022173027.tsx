          ...
          <div className="rounded-2xl bg-white shadow-lg ring-2 ring-inset ring-[#ff9501] dark:bg-[#000000] dark:shadow-2xl dark:shadow-black/50">
            <div className="p-8 sm:p-12">
              ...
              <h3 className="font-display mt-4 text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl dark:text-slate-200">
                Building the same components over and over wasting valueable
                time
              </h3>
              <ul className="mt-6 space-y-3 text-base text-slate-600 sm:text-lg dark:text-slate-400">
                <li className="flex items-start gap-3">
                  ...
                  Coding components from scratch for every new project
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  Reinventing the wheel every time you think of a new idea
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  Time-consuming and inefficient development processes
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  Wasting time on repetitive tasks instead of focusing on the
                  core product
                </li>
              </ul>
            </div>
          ...
          <div className="relative rounded-2xl bg-[#ff9501] shadow-lg ring-2 ring-inset ring-white dark:ring-white dark:shadow-2xl dark:shadow-black/50">
            <div className="relative p-8 sm:p-12">
              ...
              <h3 className="font-display mt-4 text-2xl font-bold tracking-tight text-white sm:text-3xl">
                More time to focus on what matters most: your product and your
                customers
              </h3>
              <ul className="mt-6 space-y-3 text-base text-gray-200 sm:text-lg">
                <li className="flex items-start gap-3">
                  ...
                  Customizing ready made components to fit your unique needs
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  Reusing components across multiple projects and applications
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  Efficient and scalable development processes that save time
                  and money
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                  ...
                  Ship fast and stop bottlenecking your project
                </li>
              </ul>
            </div>
          </div>
