...
export function Navbar() {
  return (
    <nav className="sticky top-0 z-50 backdrop-filter backdrop-blur-lg bg-opacity-30 border-b border-gray-200 bg-white dark:bg-gray-800 dark:bg-opacity-30 dark:border-gray-700">
