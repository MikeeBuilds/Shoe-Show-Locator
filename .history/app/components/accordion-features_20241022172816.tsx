...
import feature1 from "../../public/sneaker-marketplace.gif";
import feature2 from "../../public/vintage-events.png";
import feature3 from "../../public/seller-dashboard.gif";
          ...
          <div>
            <ul className="space-y-4">
              {features.map((feature) => (
                <li key={feature.id} className="rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
                  <button
