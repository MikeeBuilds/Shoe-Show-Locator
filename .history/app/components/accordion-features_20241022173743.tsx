...
export default function AccordionFeatures() {
  ...
  return (
    <section className="bg-background-to-b from-white to-gray-50 dark:from-neutral-900 dark:to-neutral-800">
          ...
          <div>
            <ul className="space-y-4">
              {features.map((feature) => (
                <li key={feature.id} className="rounded-lg bg-white p-6 shadow-md dark:bg-background-800">
                  <button
