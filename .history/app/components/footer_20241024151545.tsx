export function Footer() {
  return (
    <footer className="bg-white dark:bg-black bg-opacity-30 dark:bg-opacity-30 border-t border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white py-8">
        ...
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full sm:w-1/2 lg:w-1/4 mb-6">
            ...
            <ul className="text-sm space-y-2">
              ...
              <li><a href="#" className="hover:text-gray-700 dark:hover:text-gray-300">Marketplace</a></li>
              <li><a href="#" className="hover:text-gray-700 dark:hover:text-gray-300">Events</a></li>
              <li><a href="#" className="hover:text-gray-700 dark:hover:text-gray-300">Contact Us</a></li>
            </ul>
          </div>
