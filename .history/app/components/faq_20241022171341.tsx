...
const faqData = [
  {
    ...
    answer: (
      <div className="space-y-2 leading-relaxed">
        <p>
          <div>
            The Sneaker & Vintage Hub is a platform designed for sneakerheads, vintage clothing enthusiasts, and collectors. Whether you&apos;re looking to attend one of the events or using our seller marketplace, we offer a space to buy, sell, and connect with like-minded individuals.
          </div>
        </p>
      </div>
    ),
