            ...
            <div className="p-8 sm:p-12">
              ...
              <ul className="mt-6 space-y-3 text-base text-slate-600 sm:text-lg dark:text-slate-400">
                <li className="flex items-start gap-3">
                  ...
                  Limited reach to potential buyers and sellers
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  Difficulty in organizing and promoting events
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  Inefficient management of inventory and sales
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  Lack of a centralized platform for the community
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="relative p-8 sm:p-12">
              ...
              <ul className="mt-6 space-y-3 text-base text-gray-200 sm:text-lg">
                <li className="flex items-start gap-3">
                  ...
                  Connect with a global network of enthusiasts and collectors
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  Easily organize and promote events to the right audience
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  Streamlined inventory management and sales tracking
                </li>
                <li className="flex items-start gap-3">
                  <div className="shrink-0 py-1.5">
                    <svg
                  ...
                  Centralized hub for buying, selling, and community engagement
                </li>
              </ul>
            </div>
          </div>
